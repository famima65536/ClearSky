...
interface Info{
	...
	const ACCEPT_PROTOCOL = [90];
	const CURRENT_VERSION = "0.15.90";
	...
	const INVENTORY_ACTION_PACKET = 0x2a;
	...
	const BLOCK_ENTITY_DATA_PACKET = 0x33;
	const PLAYER_INPUT_PACKET = 0x34;
	const FULL_CHUNK_DATA_PACKET = 0x35;
	const SET_COMMANDS_ENABLED_PACKET = 0x36;
	const SET_DIFFICULTY_PACKET = 0x37;
	const CHANGE_DIMENSION_PACKET = 0x38;
	const SET_PLAYER_GAMETYPE_PACKET = 0x39;
	const PLAYER_LIST_PACKET = 0x3a;
	const TELEMETRY_EVENT_PACKET = 0x3b;
	const SPAWN_EXPERIENCE_ORB_PACKET = 0x3c;
	const CLIENTBOUND_MAP_ITEM_DATA_PACKET = 0x3d;
	const MAP_INFO_REQUEST_PACKET = 0x3e;
	const REQUEST_CHUNK_RADIUS_PACKET = 0x3f;
	const CHUNK_RADIUS_UPDATED_PACKET = 0x40;
	const ITEM_FRAME_DROP_ITEM_PACKET = 0x41;
	const REPLACE_SELECTED_ITEM_PACKET = 0x42;
	const GAME_RULES_CHANGED_PACKET = 0x43;
	const CAMERA_PACKET = 0x44;
	const ADD_ITEM_PACKET = 0x45;
